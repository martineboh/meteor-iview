...
export default {
    ...
    computed: {
        linkActiveClass() {
            return this.$route.meta.linkActiveClass ? this.$route.meta.linkActiveClass : this.$route.name;
        },
        pageTitle() {
            let title = 'No TiTle';
            title = this.$route.meta.pageTitle ? this.$route.meta.pageTitle : (this.$route.name ? _.startCase(this.$route.name) : title);
            ...
            _.forEach(this.$route.matched, ({ meta, path, name }) => {
                ...
                if (crumb) {
                    ...
                    if (name) {
                        ...
                        if (crumb.params) {
                            // Reduce crumb.to
                            crumb.to = _.reduce(crumb.params, (result, val) => {
                                result = _.replace(result ? result : path, val, this.$route.params[val]);
                            }, '');
                        }
                        // Check query
                        if (crumb.query) {
